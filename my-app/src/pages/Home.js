...
export default function Home() {
  return (
    <>
      ...
      <body className="home">
        <p>
          Welcome to Ryan Drake's webpage! <br/>
          ...
          You can navigate my website using the navbar at the top, where you can check out my resume and projects, or return to this homepage. <br/>
        </p>
      </body>
    </>
  )
